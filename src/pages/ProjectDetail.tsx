...
export const ProjectDetail = () => {
  ...
  const { getProjectDetails, updateMilestone, createScopeChange, approveScopeChange } = useStore();
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setNewScope({ ...newScope, costImpact: parseFloat(e.target.value) })}
                  />
                </div>
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setNewScope({ ...newScope, priceImpact: parseFloat(e.target.value) })}
                  />
                </div>
              </div>
      ...
      <ConfirmationDialog
        ...
        message={`Are you sure you want to mark "${confirmMilestone?.name}" as ${confirmMilestone?.status === 'Completed' ? 'In Progress' : 'Completed'}?`}
      ...
      <ConfirmationDialog
        ...
        message="Approving this change will permanently update the project budget and financial baselines."
